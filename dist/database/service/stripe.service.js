...
class StripeService {
    ...
    mapPaymentTypeToStripe(paymentType) {
        switch (paymentType) {
            case payment_type_enum_1.PaymentType.CREDIT_CARD:
                return ['card'];
            case payment_type_enum_1.PaymentType.UPI:
                return ['upi'];
            case payment_type_enum_1.PaymentType.BANK:
                return ['bank_transfer'];
            default:
                return ['card']; // Default to card if unknown payment type
        }
    }
}
